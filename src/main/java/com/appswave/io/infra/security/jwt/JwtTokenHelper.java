package com.appswave.io.infra.security.jwt;
...
public final class JwtTokenHelper {
    ...
    public static String generateJwtToken(int id, String username) {
        return Jwts
                   ...
                   .setExpiration(Date.from(ZonedDateTime.now()
                           .plusMinutes(JwtConfig.TOKEN_EXPIRY_DURATION)
                                                .toInstant()))
    ...
    private static class JwtConfig {
        ...
        static final String ISSUER = "appswave.io";
        static final int TOKEN_EXPIRY_DURATION = 1; // In minutes
