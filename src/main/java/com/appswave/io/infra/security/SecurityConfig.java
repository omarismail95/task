package com.appswave.io.infra.security;
        ...
        http
                ...
                .authorizeHttpRequests(auth ->
                        ...
                        auth.requestMatchers("/upload/**", "/countries/**")
                                ...
                                .hasAnyAuthority(Role.ADMIN, Role.NORMAL, Role.CONTENT_WRITER)
                                .requestMatchers(POST, "/news")
                                .hasAnyAuthority(Role.ADMIN, Role.CONTENT_WRITER)
                                .requestMatchers(PUT, "/news")
                                .hasAnyAuthority(Role.ADMIN, Role.CONTENT_WRITER)
                                .requestMatchers(DELETE, "/news")
                                .hasAnyAuthority(Role.ADMIN, Role.CONTENT_WRITER)
