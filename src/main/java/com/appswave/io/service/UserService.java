package com.appswave.io.service;
...
import com.appswave.io.infra.mapper.UserMapper;
import com.appswave.io.infra.security.jwt.JwtTokenHelper;
import com.appswave.io.repository.UserRepository;
...
public class UserService implements UserDetailsService {
    ...
    public UserResponse create(CreateUserRequest request) {
        ...
        user.setAuthorities(Role.NORMAL);
